          ...
          <div className="container-fluid">
            <div className="row align-items-center">
              <div className="col-md-12 col-12">
                ...
                <h2 className="breadcrumb-title">Pain Relif	<span className="text-small text-white ms-2"> <b>70 Products</b></span></h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="row">
                    ...
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Benzaxapine Croplex</Link> 
                        </h3>
                        <div className="row align-items-center">
                          ...
                          <div className="col-lg-6 text-end">
                            <Link to="/Pharmacy/cart" className="cart-icon"><i className="fas fa-shopping-cart" /></Link>
                          </div>
                        </div>
                      </div>
                    </div>		
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Rapalac Neuronium</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Ombinazol Bonibamol</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Dantotate Dantodazole</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Acetrace Amionel</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Ergorinex Caffeigestin</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Alispirox Aerorenone</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Lysofranil Dorzostin</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                            <span className="price">$10.00</span>
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Nitrolozin Zithrotropin</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Cordacriptine Mardipine</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Iconevist Ampyplex</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                            <span className="price">$16.00</span>
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Alcafsteride Omebide</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                            <span className="price">$7.00</span>
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Neubide Aborase</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>ITONE eye drops 10ml</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                  ...
                  <div className="col-md-12 col-lg-4 col-xl-4 product-custom">
                    <div className="profile-widget">
                      ...
                      <div className="pro-content">
                        <h3 className="title pb-4">
                          <Link to="/Pharmacy/product-description" tabIndex={-1}>Antatriene Drospiletra</Link> 
                        </h3>
                        <div className="row align-items-center">
                          <div className="col-lg-6">
                            <span className="price">$10.00</span>
