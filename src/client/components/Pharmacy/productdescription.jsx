...
const ProductDescription =(props)=>{
	...
	const getData = () => {
        fetch(`https://jeevan.studiomyraa.com/api/view-product/${id}`)
			.then((response) => response.json())
			.then((data) => setUser(data['Product-details']));
	}
  console.log(user)
                    ...
                    <div className="doctor-widget">
                      <div className="doc-info-left">
                        <div className="doctor-img1">
                          <img src={`https://jeevan.studiomyraa.com/public/uploads/images/${user.img}`} className="img-fluid" alt="User Image" />
                        </div>
                        <div className="doc-info-cont">
                          <h4 className="doc-name mb-2">{user.fullname}</h4>
                  ...
                  <div className="card-body">
                    ...
                    <div className="clinic-details mt-4">
                      <div className="clinic-booking">
                        <Link className="apt-btn" to="/Pharmacy/cart">Add To Cart</Link>
                      </div>
                    </div>
                    <div className="card flex-fill mt-4 mb-0">
                      <ul className="list-group list-group-flush">
                        <li className="list-group-item">SKU	<span className="float-end">201902-0057</span></li>
