                   ...
                   <table className="table table-hover table-center mb-0">
                     ...
                     <tbody>
                       <tr>
                         <td>
                           <h2 className="table-avatar">
                             <Link to="/Pharmacy/product-description" className="avatar avatar-sm me-2"><img className="avatar-img" src={Product} alt="User Image" /></Link>
                           </h2>
                           <Link to="/Pharmacy/product-description">Benzaxapine Croplex</Link>
                         </td>
                         <td>26565</td>
                         <td>$19</td>					
                       ...
                       <tr>
                         <td>
                           <h2 className="table-avatar">
                             <Link to="/Pharmacy/product-description" className="avatar avatar-sm me-2"><img className="avatar-img" src={Product1} alt="User Image" /></Link>
                           </h2>
                           <Link to="/Pharmacy/product-description">Ombinazol Bonibamol</Link>
                         </td>
                         <td>865727</td>
                         <td>$22</td>					
                         <td className="text-center">
                       ...
                       <tr>
                         <td>
                           <h2 className="table-avatar">
                             <Link to="/Pharmacy/product-description" className="avatar avatar-sm me-2"><img className="avatar-img" src={Product2} alt="User Image" /></Link>
                           </h2>
                           <Link to="/Pharmacy/product-description">Dantotate Dantodazole</Link>
                         </td>
                         <td>978656</td>
                         <td>$10</td>					
                         <td className="text-center">
                       ...
                       <tr>
                         <td>
                           <h2 className="table-avatar">
                             <Link to="/Pharmacy/product-description" className="avatar avatar-sm me-2"><img className="avatar-img" src={Product3} alt="User Image" /></Link>
                           </h2>
                           <Link to="/Pharmacy/product-description">Alispirox Aerorenone</Link>
                         </td>
                         <td>543252</td>
                         <td>$26</td>					
                         <td className="text-center">
                       ...
                       <tr>
                         <td>
                           <h2 className="table-avatar">
                             <Link to="/Pharmacy/product-description" className="avatar avatar-sm me-2"><img className="avatar-img" src={Product4} alt="User Image" /></Link>
                           </h2>
                           <Link to="/Pharmacy/product-description">Nitrolozin Zithrotropin</Link>
                         </td>
                         <td>634534</td>
                         <td>$12</td>					
                         <td className="text-center">
