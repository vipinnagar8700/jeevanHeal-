                ...
                <div className="doctor-widget">
                  ...
                  <div className="doc-info-right d-flex align-items-center justify-content-center">
                    <div className="clinic-booking">
                      <Link className="view-pro-btn" to="/doctor/chat-doctor">Send Message</Link>
                      <a className="apt-btn" href="#" data-bs-toggle="modal" data-bs-target="#voice_call">Call Now</a>
                      <Link to="/Pharmacy/product-all" className="view-pro-btn">Browse Products</Link>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <nav className="user-tabs mb-4">
                  <ul className="nav nav-tabs nav-tabs-bottom nav-justified">
                    <li className="nav-item" onClick={(e)=>tabclick(1) }>
                      <a className={`nav-link ${isoverview ? "active" : ""}`} href="#doc_overview" data-bs-toggle="tab">Overview</a>
                    </li>
                    <li className="nav-item" onClick={(e)=>setislocation }>
                      <a className={`nav-link ${islocation ? "active" : ""}`} href="#doc_locations" data-bs-toggle="tab">Locations</a>
                    </li>
                    <li className="nav-item" onClick={(e)=>setisisreview }>
                      <a className={`nav-link ${isreview ? "active" : ""}`} href="#doc_reviews" data-bs-toggle="tab">Reviews</a>
                    </li>
                    <li className="nav-item" onClick={(e)=>setiSbusinesshour }>
                      <a className={`nav-link ${isbusinesshour ? "active" : ""}`} href="#doc_business_hours" data-bs-toggle="tab">Business Hours</a>
                    </li>
                  </ul>
                </nav>
                {/* /Tab Menu */}
