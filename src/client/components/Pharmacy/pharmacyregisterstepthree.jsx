								...
								<div className="inner-right-login">
									<div className="login-header">
										...
										<form id="personal_details" encType="multipart/form-data">  
						                    ...
						                    <div className="step-process-col mt-4">
							                    ...
							                    <div className="checklist-col pregnant-col">
						                            <div className="remember-me-col d-flex justify-content-between">
						                                ...
						                                <label className="custom_check">
                                                            <input type="checkbox" className="" name="deliver" id="deliver" defaultValue="1"/>
                                                            <span className="checkmark"></span>
						                                </label>
						                            </div>
						                            <div className="remember-me-col d-flex justify-content-between">
					                        ...
					                        <div className="mt-5">
					                        	<Link to="/Pharmacy/Pharmacy-index" className="btn btn-primary w-100 btn-lg login-btn step2_submit" id="step2_button" >continue </Link>
					                        </div>
				                        </form>
									</div>
								</div>
