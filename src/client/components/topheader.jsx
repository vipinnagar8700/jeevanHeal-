                  ...
                  >
                    ...
                    {isSideMenu == "home" ? (
                      <ul className="submenu">
                        ...
                        <li
                          className={
                            pathnames.includes("home5") ? "active" : ""
                          }
                        >
                        ...
                        <li
                          className={
                            pathnames.includes("/home7") ? "active" : ""
                          }
                        >
                        ...
                        <li
                          className={
                            pathnames.includes("/home8") ? "active" : ""
                          }
                        >
                  ...
                  <li className="has-submenu">
                    ...
                    {isSideMenu == "admin" ? (
                      <ul className="submenu">
                        <li>
                          <a
                            href={`${config.publicPath}admin/login`}
                            target="_blank"
                          >
                            Admin
                          </a>
                        ...
                        <li>
                          <a
                            href={`${config.publicPath}pharmacyadmin`}
                            target="_blank"
                          >
                            Pharmacy Admin
                          </a>
