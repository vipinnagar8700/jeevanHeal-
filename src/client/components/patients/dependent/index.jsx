...
const Dependent =(props)=>{    
    ...
    const handleChange = (date) => {
        ...
        <div>
                     ...
                     <div className="col-md-12 col-12">
                        <nav aria-label="breadcrumb" className="page-breadcrumb">
                           <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Dependent</li>
                           </ol>
                        </nav>
                              ...
                              <div className="row">
                                 ...
                                 <div className="col-sm-6">
                                    <div className="text-end">
                                       <a href="#modal_form" data-bs-toggle="modal" onClick={()=> setShow(true)} className="btn btn-primary btn-sm" tabIndex={0}>Add Dependent</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <div className="table-action">
                                                      <a href="#edit_form" className="btn btn-sm bg-info-light" data-bs-toggle="modal" onClick={()=> setEdit(true)}>	<i className="fas fa-edit" /> Edit</a>
                     ...
                     <form action="#" encType="multipart/form-data" autoComplete="off" method="post">
                        <div className="modal-body">
                           ...
                           <div className="form-group">
                              ...
                              <DatePicker  name="dob" id="dob" selected={date} onChange={handleChange} className="form-control date-icon" />
                           </div>
                           <div className="form-group">
            ...
            <div id="edit_form" className="modal fade custom-modal" tabIndex="-1" role="dialog" aria-modal="true" show={edit} onClick={()=>
               setEdit(false)}>
                  ...
                  <div className="modal-content">
                     <form action="#" encType="multipart/form-data" autoComplete="off" method="post">
                        ...
                        <div className="modal-body">
                           <div className="form-group">
                              <label className="control-label mb-10"> Name <span className="text-danger">*</span></label>
                              <input type="text" name="name" className="form-control" defaultValue="Christopher"/>
                           </div>
                           <div className="form-group">
                              <label className="control-label mb-10">Relationship </label>
                              <input type="text" name="relationship" className="form-control" defaultValue="son"/>
                           </div>
                           <div className="form-group">
                              <label className="control-label mb-10">Gender </label>
                           ...
                           <div className="form-group">
                              <label className="control-label mb-10">DOB </label>
                              <DatePicker  name="dob" id="editdob" selected={date} onChange={handleChange} className="form-control date-icon" />                           
                           </div>
                           <div className="form-group">
                              <label className="control-label mb-10">Photo </label>
                              <input type="file"  name="profile_image" className="form-control"/>
