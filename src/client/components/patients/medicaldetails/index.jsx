                     ...
                     <div className="col-md-12 col-12">
                        <nav aria-label="breadcrumb" className="page-breadcrumb">
                           <ol className="breadcrumb">
                              ...
                              <li className="breadcrumb-item active" aria-current="page">Medical Details</li>
                           </ol>
                        </nav>
                           ...
                           <div className="col-sm-12">
                              <div className="card">
                                 <div className="card-header">
                                    ...
                                    <a href="#modal_medical_form" className="btn btn-primary float-end" onClick={()=> setShow(true)} data-bs-toggle="modal">Add Details</a>
                                 </div>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <div className="table-action">
                                                            <a href="#edit_medical_form" onClick={()=> setShow(true)} className="btn btn-sm bg-info-light" data-bs-toggle="modal">
                        ...
                        <form action="#" encType="multipart/form-data" autoComplete="off" method="post">
                           <div className="modal-body">
                              ...
                              <div className="form-group">
                                 <label className="control-label mb-10"> BMI <span className="text-danger">*</span></label>
                                 <input type="text" name="bmi" className="form-control" defaultValue="23.7" />
                              </div>
                              <div className="form-group">
                                 <label className="control-label mb-10">Heart rate </label>
                                 <input type="text" name="hr" className="form-control" defaultValue={89} />
                              </div>
                              <div className="form-group">
                                 <label className="control-label mb-10">Weight</label>
                                 <input type="text" name="Weight" className="form-control" defaultValue={74} />
                              </div>
                              <div className="form-group">
                                 <label className="control-label mb-10">Fbc</label>
                                 <input type="text" name="Fbc" className="form-control" defaultValue={140} />
                              </div>
                              <div className="form-group">
                                 <label className="control-label mb-10">Created Date </label>
                                 <input type="text" name="dob" id="editdob" defaultValue="11/11/2019" readOnly className="form-control" />
                              </div>
                           </div>
