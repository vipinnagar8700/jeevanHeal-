                                ...
                                <div className="table-responsive">
                                    <table className="table table-hover table-center mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td><Link to="/pages/invoice-view">OD1236547890</Link></td>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td><Link to="/pages/invoice-view">OD1236547891</Link></td>
                                                <td>Medlife Medical</td>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td><Link to="/pages/invoice-view">OD1236547892</Link></td>
                                                <td>Medlife Medical</td>
                                            ...
                                            <tr>
                                                <td>4</td>
                                                <td><Link to="/pages/invoice-view">OD1236547893</Link></td>
                                            ...
                                            <tr>
                                                <td>5</td>
                                                <td><Link to="/pages/invoice-view">OD1236547894</Link></td>
                                                <td>PharmaMed Medical</td>
                                            ...
                                            <tr>
                                                <td>6</td>
                                                <td><Link to="/pages/invoice-view">OD1236547895</Link></td>
