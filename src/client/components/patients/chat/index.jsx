...
import { IMG01, IMG02, IMG03, IMG04, IMG05, IMG06, IMG07, IMG08, IMG09, IMG010, IMG011, doctor1, doctor_thumb3, doctor_thumb4, doctor_thumb5, doctor_thumb6, doctor_thumb7, doctor_thumb8, doctor_thumb9, doctor_thumb10 } from './img';
									...
									<div className="chat-users-list">
										<div className="chat-scroll">
											<a href="#" className="media d-flex">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-away">
														<img src={doctor1} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
											...
											<a href="#" className="media d-flex">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-away">
														<img src={doctor_thumb3} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
											...
											<a href="#" className="media d-flex read-chat">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-online">
														<img src={doctor_thumb4} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
											...
											<a href="#" className="media d-flex read-chat">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-offline">
														<img src={doctor_thumb5} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
											...
											<a href="#" className="media d-flex read-chat">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-online">
														<img src={doctor_thumb6} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
											...
											<a href="#" className="media d-flex read-chat">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-away">
														<img src={doctor_thumb7} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
											...
											<a href="#" className="media d-flex read-chat">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-offline">
														<img src={doctor_thumb8} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
											...
											<a href="#" className="media d-flex read-chat">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-online">
														<img src={doctor_thumb9} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
											...
											<a href="#" className="media d-flex read-chat">
												<div className="media-img-wrap flex-shrink-0">
													<div className="avatar avatar-away">
														<img src={doctor_thumb10} alt="User " className="avatar-img rounded-circle" />
													</div>
												</div>
												<div className="media-body flex-grow-1">
													<div>
								...
								<div className="chat-cont-right">
									...
									<div className="chat-footer">
										<div className="input-group">
											...
											<button type="button" className="btn msg-send-btn rounded-pill ms-2"><i className="fab fa-telegram-plane"></i></button>
										</div>
									</div>
								</div>
