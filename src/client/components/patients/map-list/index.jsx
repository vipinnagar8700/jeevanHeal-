...
import { IMG01, IMG02, IMG03, IMG05,tooth,thums,star,location,chat,money,InfoCircle,doctor_thumb1,doctor_thumb2,doctor_thumb3,doctor_thumb4,doctor_thumb5,doctor_thumb6  } from './img';
                     ...
                     <div className="row align-items-center mb-4">
                        ...
                        <div className="col-md-6 col-auto">
                           <div className="view-icons">
                              ...
                              <Link to="/patient/doctor-list" className="list-view active">
                     ...
                     <div className="row align-items-center">
                        ...
                        <div className="col-md-6 col-auto">
                           <div className="arrows">
                              <a href="#" className="perv-date">
                                 <i className="fas fa-angle-left" />
                              </a>
                              <a href="#" className="next-date">
                           ...
                           <div className="doctor-widget doctor-col">
                              ...
                              <div className="doc-info-right appt-date">
                                 ...
                                 <div className="clinic-booking book-btns">
                                    <Link className="view-pro-btn" to="/patient/doctor-profile">
                                       View all availability
                                    </Link>
                                    <a className="apt-btn" to="/patient/booking">
                                       Book an Appointment
                                    </a>
                                 </div>
                              </div>
                           ...
                           <div className="doctor-widget doctor-col">
                              ...
                              <div className="doc-info-right appt-date">
                                 ...
                                 <div className="clinic-booking book-btns">
                                    ...
                                    <Link className="apt-btn" to="/patient/booking">
                                       Book an Appointment
                                    </Link>
                                 </div>
                              </div>
