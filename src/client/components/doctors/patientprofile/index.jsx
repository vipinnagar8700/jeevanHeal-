								...
								<div className="card-body pt-0">
									<div className="user-tabs">
										<ul className="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
											...
											<li className="nav-item">
												<a className="nav-link" href="#pres" data-bs-toggle="tab"><span>Prescription</span></a>
											</li>
											<li className="nav-item">
												<a className="nav-link" href="#medical" data-bs-toggle="tab"><span className="med-records">Medical Records</span></a>
											</li>
											<li className="nav-item">
												<a className="nav-link" href="#billing" data-bs-toggle="tab"><span>Billing</span></a>
											</li> 
										</ul>
									</div>
									<div className="tab-content">
														...
														<table className="table table-hover table-center mb-0">
															...
															<tbody>
																...
																<tr>
																	...
																	<td className="text-end">
																		<div className="table-action">
																			<Link to="/editprescription" className="btn btn-sm bg-success-light">
																				<i className="far fa-edit"></i> Edit
																			</Link>
																...
																<tr>
																	...
																	<td>$275</td>
																	<td>9 Nov 2019</td>
																	<td><span className="badge rounded-pill bg-info-light">Completed</span></td>
																	<td className="text-end">
																		<div className="table-action">
										...
										<div className="tab-pane fade" id="pres">
											<div className="text-end">
												<Link to="/add-prescription" className="add-new-btn">Add Prescription</Link>
											</div>
											<div className="card card-table mb-0">
												<div className="card-body">
													<div className="table-responsive">
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		<h2 className="table-avatar">
																			...
																			<Link to="/patient/doctor-profile">Dr. Marvin Campbell <span>Dental</span></Link>
																		</h2>
																	</td>
																	<td className="text-end">
																		<div className="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 className="table-avatar">
																			...
																			<Link to="/patient/doctor-profile">Dr. Linda Tobin <span>Neurology</span></Link>
																		</h2>
																	</td>
																	<td className="text-end">
																		<div className="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 className="table-avatar">
																			...
																			<Link to="/patient/doctor-profile">Dr. Paul Richard <span>Dermatology</span></Link>
																		</h2>
																	</td>
																	<td className="text-end">
																		<div className="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 className="table-avatar">
																			...
																			<Link to="/patient/doctor-profile">Dr. John Gibbs <span>Dental</span></Link>
																		</h2>
																	</td>
																	<td className="text-end">
																		<div className="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 className="table-avatar">
																			<Link to="/patient/doctor-profile" className="avatar avatar-sm me-2">
																				<img className="avatar-img rounded-circle" src={IMG10} alt="User Image"/>
																			</Link>
																			<Link to="/patient/doctor-profile">Dr. Olga Barlow <span>Dental</span></Link>
																		</h2>
																	</td>
																	<td className="text-end">
																		<div className="table-action">
																...
																<tr>
																	...
																	<td className="text-end">
																		<div className="table-action">
																			...
																			<Link to="/editprescription" className="btn btn-sm bg-success-light" data-bs-toggle="modal" data-bs-target="#add_medical_records">
																				<i className="fas fa-edit"></i> Edit
																			</Link>
																			<Link to="#" className="btn btn-sm bg-danger-light">
																				<i className="far fa-trash-alt"></i> Delete
																...
																<tr>
																	...
																	<td>
																		<h2 className="table-avatar">
																			...
																			<Link to="/patient/doctor-profile">Ruby Perrin <span>Dental</span></Link>
																		</h2>
																	</td>
																	<td>$450</td>
																	<td>14 Nov 2019</td>
																...
																<tr>
																	...
																	<td className="text-end">
																		<div className="table-action">
																			...
																			<Link to="/editbilling" className="btn btn-sm bg-success-light">
																				<i className="fas fa-edit"></i> Edit
																			</Link>
																			<Link to="#" className="btn btn-sm bg-danger-light">
																				<i className="far fa-trash-alt"></i> Delete
																...
																<tr>
																	...
																	<td>
																		<h2 className="table-avatar">
																			...
																			<Link to="/patient/doctor-profile">Dr. Olga Barlow <span>#0010</span></Link>
																		</h2>
																	</td>
																	<td>$550</td>
																	<td>5 Nov 2019</td>
