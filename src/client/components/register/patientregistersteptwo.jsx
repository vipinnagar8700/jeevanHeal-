					...
					<div className="login-header">
						...
						<div className="step-process-col mt-4">
							...
							<div className="remember-me-col d-flex justify-content-between">
								...
								<label className="custom_check">
								<input type="checkbox" className="" name="medicine" id="medicine" onclick="show_medicine()" defaultValue={1}/>
								<span className="checkmark" />
								</label>
							</div>
							<div className="remember-me-col" id="medicine_div" style={{ display: "none" }}>
								<div className="medicine_input">
									<input type="text" id="medicine_name" name="medicine_name[]" defaultValue="" className="form-control" placeholder="Enter medicine_name"/>
									<input type="text" defaultValue="" id="dosage" name="dosage[]" className="form-control" placeholder="Enter dosage"/>
								</div>
						...
						<div className="mt-5">
							<Link to="/patient/patientregisterstep-3" className="btn btn-primary w-100 btn-lg login-btn step2_submit">continue{" "}</Link>
						</div>
						</form>
					</div>
					</div>
