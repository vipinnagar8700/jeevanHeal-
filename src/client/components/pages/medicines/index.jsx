...
import {
	product8, product9, product10, product11, product12, product13, product14, product15, ourd1,
	ourd2,
	ourd3,
	ourd4,
	download,
		...
		<>
			...
			<div className="content">
				<div className="container-fluid">
					<div className="row">
					<div class="search-box"><form action="/patient/search-doctor" ><div class="form-group search-location">
						<input type="text" class="form-control" placeholder="Search Location" />
					</div>
						
							<button type="submit" class="btn btn-primary search-btn mt-0">
								<i class="fas fa-search"></i> <span>Search</span></button></form></div>
								...
								{post.data ? post.data.length > 0 && (
										...
										{post.data.map((items, index) => {
											return (
												...
												<div className="col-md- col-lg-4 col-xl-4 product-custom">

													<div className="profile-widget">
														<div className="doc-img">
															<Link to={"/Pharmacy/product-description/" + items.id} >
																<img
																	className="img-fluid"
																	alt="Product image"
																	src={`https://jeevan.studiomyraa.com/public/uploads/images/${items.img}`}
																/>
															</Link>
															<a
																href="#"
														...
														<div className="pro-content">
															...
															<div className="row align-items-center">
																<div className="col-lg-6">
																	...
																	<span className="price-strike">$30.00</span>
																</div>
