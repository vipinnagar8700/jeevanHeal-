              ...
              <div className="terms-content">
                <div className="terms-text">
                  ...
                  <ol>
                    ...
                    <li>
                      Mauris eget turpis sit amet purus pulvinar facilisis at
                      sed lacus.
                    </li>
                    <li>
                      Quisque malesuada volutpat orci, accumsan scelerisque
                ...
                <div className="terms-text">
                  ...
                  <p>
                    Donec posuere dictum enim, vel sollicitudin orci tincidunt
                    ac. Maecenas mattis ex eu elit tincidunt egestas. Vivamus
                    posuere nunc vel metus bibendum varius. Vestibulum suscipit
                    lacinia eros a aliquam. Sed dapibus arcu eget egestas
                    hendrerit.
                  </p>
                ...
                <div className="terms-text">
                  ...
                  <ul>
                    ...
                    <li>
                      Suspendisse eu risus feugiat, pellentesque arcu eu,
                      molestie lorem.{" "}
                    </li>
                    <li>
                ...
                <div className="terms-text">
                  ...
                  <p>
                    ...
                    tincidunt ac. Maecenas mattis ex eu elit tincidunt egestas.
