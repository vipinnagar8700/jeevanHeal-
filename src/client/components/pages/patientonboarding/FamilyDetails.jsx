...
const PatientFamilyDetails = (props) => {
                                                 ...
                                                 <div className="checklist-col pregnant-col">
                                                    <div className="remember-me-col d-flex justify-content-between">
                                                        ...
                                                        <label className="custom_check">
                                                            <input type="checkbox" className="" name="self" id="self" defaultValue="1" checked={true}/>
                                                    ...
                                                    <div className="remember-me-col d-flex align-items-center justify-content-between">
                                                        ...
                                                        <div className="increment-decrement">
                                                            <div className="input-groups">
                                                                <input onClick= {dicrementCount} type="button" value="-" id="subs" className="button-minus dec button"  />
                                                                <input type="text" name="child" id={count}  className="quantity-field"/>
                                                                <div className='me-3'>
                                                                  {count}
                                                                </div>
                                                                
                                                                <input onClick={incrementCount} type="button" defaultValue="+" id="adds" className="button-plus inc button a1 a2 a3 a4 a0" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="remember-me-col d-flex align-items-center justify-content-between">
