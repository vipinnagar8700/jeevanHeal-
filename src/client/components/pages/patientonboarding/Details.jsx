...
const OnboardingDetails = (props) => {
  ...
  const handleInput=(value)=>{
    ...
    if(value === "heartRate") setInput({...input, heartRate: !input.heartRate});
    if(value === "bloodPressure") setInput({...input, bloodPressure: !input.bloodPressure});
    if(value === "glucose") setInput({...input, glucose: !input.glucose});
    if(value === "allergies") setInput({...input, allergies: !input.allergies});
                      ...
                      <form id="personal_details" encType="multipart/form-data">
                        ...
                        <div className="row">
                          <div className="col-lg-9">
                            <div className="form-group">
                              <div onClick={()=> handleInput("weight")} className={` input-placeholder form-focus passcode-wrap mail-box ${input.weight ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                          ...
                          <div className="col-lg-3">
                            <div className="form-group">
                              ...
                              <Select styles={customStyles} options={Weight} placeholder="KG" />
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-9">
                            <div className="form-group">
                              <div onClick={()=>  handleInput("height")} className={` input-placeholder form-focus passcode-wrap mail-box ${input.height ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                <label className="focus-label">
                          ...
                          <div className="col-lg-3">
                            <div className="form-group">
                              <div className="passcode-wrap input-placeholder form-focus">
                              <Select styles={customStyles} options={Height} placeholder="CM" />
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-12">
                            <div className="form-group">
                              <div onClick={()=> handleInput('age')} className={` input-placeholder form-focus passcode-wrap mail-box ${input.age ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                <label className="focus-label">
                                  Age<span>*</span>
                                </label>
                                <input
                          ...
                          <div className="col-lg-12">
                            <div className="form-group">
                              <div className="passcode-wrap input-placeholder form-focus">
                              <Select styles={BloodStyles} options={Blood} placeholder="Blood Type" />
                              </div>
                            </div>
                          </div>
                          <div className="col-lg-12">
                            <div className="form-group">
                              <div onClick={()=> handleInput('heartRate')} className={` input-placeholder form-focus passcode-wrap mail-box ${input.heartRate ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                <label className="focus-label">
                          ...
                          <div className="col-lg-12">
                            <div className="form-group">
                              <div onClick={()=> handleInput('bloodPressure')} className={` input-placeholder form-focus passcode-wrap mail-box ${input.bloodPressure ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                <label className="focus-label">
                          ...
                          <div className="col-lg-12">
                            <div className="form-group">
                              <div onClick={()=> handleInput('glucose')} className={` input-placeholder form-focus passcode-wrap mail-box ${input.glucose ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                <label className="focus-label">
                          ...
                          <div className="col-lg-12">
                            <div className="form-group">
                              <div onClick={()=> handleInput('allergies')} className={` input-placeholder form-focus passcode-wrap mail-box ${input.allergies ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                <label className="focus-label">
                                  Allergies <span>*</span>
                                </label>
                                <input
                          ...
                          <div className="col-lg-12">
                            ...
                            {pregnant && (<div className="step-process-col mt-4">
                                <div
                                  className="form-group"
                                  id="preg_div"
                                >

                                <Select styles={PregnantStyles} options={Month} placeholder="Select Month" />
                                </div>
                              </div>)}
                            </div>
                            <div className="col-lg-12">
                              <div className="form-group">
                                <div className="checklist-col">
                                  ...
                                  >
                                    ...
                                    <a href="#" className="add_condition">
