                                  ...
                                  <div className="row">
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleChild("name")}  className={` input-placeholder form-focus passcode-wrap mail-box ${child.name ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                    ...
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleChild("age")}  className={` input-placeholder form-focus passcode-wrap mail-box ${child.age ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                          <label className="focus-label">
                                            Age <span>*</span>
                                          </label>
                                          <input
                              ...
                              >
                                <div className="accordion-body">
                                  <div className="row">
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleSpouse("name")}  className={` input-placeholder form-focus passcode-wrap mail-box ${spouse.name ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                          <label className="focus-label">
                                            Name
                                          </label>
                                          <input
                                    ...
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleSpouse("age")}  className={` input-placeholder form-focus passcode-wrap mail-box ${spouse.age ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                          <label className="focus-label">
                                            Age <span>*</span>
                                          </label>
                                          <input
                              ...
                              >
                                <div className="accordion-body">
                                  <div className="row">
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleFather("name")}  className={` input-placeholder form-focus passcode-wrap mail-box ${father.name ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                          <label className="focus-label">
                                            Name
                                          </label>
                                          <input
                                    ...
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleFather("age")}  className={` input-placeholder form-focus passcode-wrap mail-box ${father.age ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                          <label className="focus-label">
                                            Age <span>*</span>
                                          </label>
                                          <input
                              ...
                              >
                                <div className="accordion-body">
                                  <div className="row">
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleMother("name")}  className={` input-placeholder form-focus passcode-wrap mail-box ${mother.name ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                          <label className="focus-label">
                                            Name
                                          </label>
                                          <input
                                    ...
                                    <div className="col-lg-12">
                                      <div className="form-group ">
                                        <div onClick={()=>handleMother("age")}  className={` input-placeholder form-focus passcode-wrap mail-box ${mother.age ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                          <label className="focus-label">
                                            Age <span>*</span>
                                          </label>
                                          <input
