          ...
          <div className="row">
            ...
            <div className="onboarding-content-box content-wrap">
                                        ...
                                        <form method="post">
                                            <div className="col-lg-12">
                                                <div className="form-group ">
                                                    <div onClick={()=> setInput(true)}  className={` input-placeholder form-focus passcode-wrap mail-box ${input ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                    <Select styles={customStyles} options={City} placeholder="Select City" />
                                                </div>
                                                </div>
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                    <Select styles={customStyles} options={State} placeholder="Select State" />
                                                    </div>
                                                </div>
                                                <div className="col-lg-12">
                                                    <div className="form-group">
                                                    <Select styles={customStyles} options={Country} placeholder="Select Country" />
                                                    </div>
                                                </div>
                                                <div className="col-lg-12">
                                                    <div className="form-group ">
                            ...
                            <div className="onboarding-btn">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#profile-completed" >Continue</a>
                            </div>
                            {/* <!-- Modal --> */}
                            <div className="modal fade fade-custom" id="profile-completed" tabindex="-1"
                            aria-hidden="true">
