...
const Onboardingpassword = (props) => {
              ...
              <div className="onboarding-content">
                <div className="row">
                  <div className="col-lg-12">
                    ...
                    <div  onClick={()=>handleinput("password")}  className={` input-placeholder form-focus passcode-wrap mail-box ${input.password ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                  ...
                  <div className="col-lg-12">
                    ...
                    <div  onClick={()=> handleinput("confirm")}  className={` input-placeholder form-focus passcode-wrap mail-box ${input.confirm ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
                        <label className="focus-label">
