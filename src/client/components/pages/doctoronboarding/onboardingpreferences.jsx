...
import {onelogo,oneslide,success_tick,mic_black,video_icon,ch,repeat} from "./img"
																	...
																	<div className="row">
																		<div className="col-lg-2">
																			<div className="form-group">
																				...
																				<Select styles={customStyles} options={State} placeholder="Euro" />
													...
													>
														<div className="accordion-body">
															<div className="onboarding-title">
																...
																<h6>
																	You can select more than one from the below. These
																	will show up as options for the patient when
															...
															<div className="onboarding-content">
																<div className="consult-option mb-lg-4 mb-sm-1">
																	<div className="call-option">
																		<input
																			...
																			defaultChecked=""
																		/>
																		<label htmlFor="radio1" className="call-lable">
																			{" "}
																			<img
																				src={mic_black}
																				alt=""
																	...
																	<div className="call-option">
																		<input
																			...
																			className="option-radio"
																		/>
																		<label htmlFor="radio2" className="call-lable">
																			<img
																				src={video_icon}
																				alt=""
																			/>
																	...
																	<div className="call-option">
																		<input
																			...
																			className="option-radio"
																		/>
																		<label htmlFor="radio3" className="call-lable">
																			{" "}
																			<img src={ch} alt="" />
																			Chat
																		</label>
																...
																<div className="onboarding-title">
																	<h6>
																		Choose your preferred language for Audio, Video
																		calls and chat. You can select more than one
																		option.
																	</h6>
																</div>
																<div className="form-group">
																	...
																	<Select styles={LanguageStyles} options={Lang} placeholder="Choose your Language" />
																...
																<div className="row">
																	...
																	<div className="col-lg-6">
																		<div className="form-group">
																			...
																			<Select styles={LanguageStyles} options={Time} placeholder="Start Time" />
																	...
																	<div className="col-lg-6">
																		<div className="form-group">
																			...
																			<Select styles={LanguageStyles} options={Time} placeholder="End Time" />
																	...
																	<div className="modal-dialog id-upload modal-dialog-centered">
																		<div className="modal-content id-pop-content">
																			...
																			<div className="modal-footer id-pop-footer text-center">
																				<div className="onboarding-btn pop-btn " onClick={()=> window.location.reload()}>
