										...
										<div className="row">
											<div className="col-lg-12">
												<div className="form-group">
													<div  onClick={handletinput}  className={` input-placeholder form-focus passcode-wrap mail-box ${input ? "input-placeholder form-focus passcode-wrap mail-box focused" : "" }`}>
