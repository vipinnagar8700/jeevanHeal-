...
const Onboardingverification = (props) => {
  const customStyles = {
		menu: (provided, state) => ({
		  ...provided,
		//   paddingTop: 20,
              ...
              <div className="row">
                  ...
                  <div className="verify-box">
                    <ul className="verify-list">
                      <li className="verify-item">
                        Certificate of Registration with the Maltese Medical
                        Council OR Registration from the appropriate
                        Professional Council
                      </li>
                      <li className="verify-item">
                        Certificate of Good Standing (from the Maltese Medical
                        Council - valid for 3 months from the date of issue).
                        Doctors applying from overseas are to provide a
                        Certificate of Good Standing issued from the most recent
                        country of residence / practise (valid for 3 months from
                        the date of issue) (only applicable for Medical Doctors)
                      </li>
                ...
                <div className="col-lg-12">
                  <div className="form-group mt-4">
                    ...
                    <Select styles={customStyles} options={AreaofInterest} placeholder="Select Area of Specialisation" />
                  </div>
                </div>
              </div>
            </div>
