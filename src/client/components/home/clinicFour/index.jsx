...
import {clinic_big_img,features_clinic_02,features_clinic_03,features_clinic_04,features_clinic_01 } from "../image.jsx";
//slider
    ...
    <div className="container-fluid">
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-12">
            ...
            <div className="owl-carousel features-clinic-slider-four owl-theme aos" data-aos="fade-up">
            <OwlCarousel  {...settings}> 
            
              <div className="item ">
                <div className="features-clinic-grid">
                  <div className="features-clinic-img">
                    <img src={features_clinic_01} alt="" className="img-fluid"/>
                  </div>
              ...
              <div className="item">
                <div className="features-clinic-grid">
                  <div className="features-clinic-img">
                    <img src={features_clinic_02} alt="" className="img-fluid"/>                      
                  </div>
                  <div className="feature-clinic-overlay">
                    <p>Patient Ward</p>
                  </div>
              ...
              <div className="item">
                <div className="features-clinic-grid">
                  <div className="features-clinic-img">
                    <img src={features_clinic_03} alt="" className="img-fluid"/>
                  </div>
                  <div className="feature-clinic-overlay">
                    <p>Operation</p>
                  </div>
              ...
              <div className="item">
                <div className="features-clinic-grid">
                  <div className="features-clinic-img">
                    <img src={features_clinic_04} alt="" className="img-fluid"/>
                  </div>
                  <div className="feature-clinic-overlay">
                    <p>Laboratory</p>
                  </div>
