								...
								<div className="row mb-5">
                                    <div className="col">
                                        <ul className="nav nav-tabs nav-tabs-solid">
                                            ...
                                            <li className="nav-item">
                                                <Link className="nav-link" to="/blog/doctor-pending-blog">Pending Blog</Link>
                                            </li>
                                        </ul>
                                    </div>
									...
									<div className="card-body">	
										...
										<form method="post" encType="multipart/form-data" autoComplete="off" id="update_service" action="/doctor-blog">
												...
												<div className="row">
													<div className="col-lg-6">
														<div className="form-group">
															...
															<select className="form-select form-control" name="category" required=""> 
																...
																<option defaultValue="2" selected="selected">Construction</option>
																...
																<option defaultValue="10">Category Test</option>
																<option defaultValue="11">dfdf</option>
																<option defaultValue="12">Equipment</option>
																<option defaultValue="13">Test category1</option>
																<option defaultValue="14">Farming</option>
																<option defaultValue="15">Test Category02</option>
													...
													<div className="col-lg-6">
														<div className="form-group">
															...
															<option defaultValue="13">Full Car Wash</option>
															<option defaultValue="14" selected="selected">Testing category</option>
															<option defaultValue="15">Test Sub category</option>
															<option defaultValue="16">Harvesting pine</option>
															<option defaultValue="17">Test Sub category name</option>
															<option defaultValue="18">Test Sub category name</option>
														</select>
														</div>
													</div>
												</div>
												...
												<div className="row">
													<div className="col-lg-12">
														<div className="form-group">
															...
															<textarea id="about" className="form-control service-desc" name="about">note.</textarea>
														</div>
													</div>
												</div>
											</div>
											...
											<div className="submit-section">
												<button className="btn btn-primary submit-btn" type="submit" name="form_submit" defaultValue="submit">Submit</button>
											</div>
										</form>
