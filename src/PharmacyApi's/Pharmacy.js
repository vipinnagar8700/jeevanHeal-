...
export const edit_PurchaseData = async (p_id) => {
    const res = await axios.get(`https://jeevan.studiomyraa.com/api/view_purchase/` + p_id);
    return res.data.results;
...
export const edit_supplierData = async (p_id) => {
    const res = await axios.get(`https://jeevan.studiomyraa.com/api/get_single_supplier/` + p_id);
    return res.data.results;
