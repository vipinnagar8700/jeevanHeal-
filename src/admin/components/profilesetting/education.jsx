     ...
     <>
        ...
        <div className="card">
            <div className="card-body">
                ...
                return(
                <div className="education-info" key={index}  onChange={(evnt)=>handleChanges(index, evnt)}>
                ...
                <div className="add-more" onClick={addInputField}>
                    <a href="#" className="add-education"><i className="fa fa-plus-circle"></i> Add More</a>
                </div>
            </div>
        </div>
        {/* <!-- /Education -->     */}
