    ...
    <div className="content container-fluid">
      ...
      <div className="row">
        ...
        <div className="col-md-3 text-md-end">
          <Link to="/admin/add-blog" className="btn btn-primary btn-blog mb-3">
            Add Blog
          </Link>
        </div>
      </div>
          ...
          <div className="blog grid-blog flex-fill">
            ...
            <div className="row">
              ...
              <div className="col text-end">
                ...
                >
                  <i className="me-1"><FeatherIcon icon="eye-off"/></i> Inactive
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="col-md-6 col-xl-4 col-sm-12 d-flex">
          <div className="blog grid-blog">
            ...
            <div className="blog-content">
              ...
              <p>
                LLorem ipsum dolor sit amet, consectetur em adipiscing elit, sed
                do eiusmod tempor...
              </p>
            </div>
            <div className="row">
            ...
            <ul className="pagination mb-0">
              <li className="page-item disabled">
                <Link className="page-link" to="#" tabIndex={-1}>
                  ...
                  <i className="me-2"><FeatherIcon icon="chevron-left"/></i>
                  Previous
                </Link>
              </li>
              ...
              <li className="page-item">
                <Link className="page-link" to="#">
                  Next
                  <i className="ms-2"><FeatherIcon icon="chevron-right"/></i>
                </Link>
              </li>
            </ul>
          </div>
