...
import { avatar02, avatar03, avatar04, avatar05, avatar06, avatar07, avatar08, avatar09, avatar10, blog01, blog02, blog03, blog04, blog06, blog07, blog08, blog09, eyeIcon, replyIcon } from '../imagepath';
          ...
          <div className="blog-view">
            <div className="blog-single-post">
              <Link to="/admin/blog" className="back-btn">
                <i><FeatherIcon icon="chevron-left"/></i>Back
              </Link>
              ...
              <div className="blog-info">
                <div className="post-list">
                  <ul>
                    ...
                    <li>
                    <i><FeatherIcon icon="clock"/></i> 40 Comments
                    </li>
                    <li>
                      <i><FeatherIcon icon="message-square"/></i> 40 Comments
                    </li>
                    <li>
                      <i><FeatherIcon icon="grid"/> </i>Topical chemotherapy,
                      Gynacologist
                    </li>
                  </ul>
                </div>
                        ...
                        <div className="comment-by">
                          <h5 className="blog-author-name">
                            ...
                            <span className="blog-date">
                              {" "}
                              <i className="me-2"><FeatherIcon icon="clock"/></i>
                              Dec 6, 2017
                            </span>
                          </h5>
                        </div>
                          ...
                          <div className="comment-block">
                            <div className="comment-by">
                              <h5 className="blog-author-name">
                                ...
                                <span className="blog-date">
                                  {" "}
                                  <i className="me-2"><FeatherIcon icon="clock"/></i> 6 Dec
                                  2022
                                </span>
                              </h5>
                            </div>
                          ...
                          <div className="comment-block">
                            <div className="comment-by">
                              <h5 className="blog-author-name">
                                ...
                                <span className="blog-date">
                                  {" "}
                                  <i className="me-2"><FeatherIcon icon="clock"/></i> 7 Dec
                                  2022
                                </span>
                              </h5>
                            </div>
                            <p>
                              ...
                              pellentesque urna consectetur adipiscing elit. Nam
                              viverra euismod.
                            </p>
                            <Link className="comment-btn" to="#">
                              <img
                      ...
                      <div className="comment-block">
                        <div className="comment-by">
                          <h5 className="blog-author-name">
                            ...
                            <span className="blog-date">
                              {" "}
                              <i className="me-2"><FeatherIcon icon="clock"/></i> 7 Dec 2022
                            </span>
                          </h5>
                        </div>
                        <p>
                      ...
                      <div className="comment-block">
                        <div className="comment-by">
                          <h5 className="blog-author-name">
                            ...
                            <span className="blog-date">
                              {" "}
                              <i className="me-2"><FeatherIcon icon="clock"/></i> 12 Dec 2022
                            </span>
                          </h5>
                        </div>
                        <p>
