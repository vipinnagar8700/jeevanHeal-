...
import { avatar02, avatar04, avatar05, avatar06, avatar07, avatar10, avatar11, avatar12, avatar13, product1, product2, product3, product4, product5 } from '../imagepath';
  ...
  PhoneNumber:"916-631-2558",
	...
	const columns = [
						...
						
        {
			...
			className="user-name">{row.PharmacyName}
